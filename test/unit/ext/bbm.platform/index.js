...
describe("bbm.platform index", function () {
    ...
    describe("bbm.platform.users.profilebox", function () {
        ...
        describe("getItemIcon", function () {
            it("can call getItemIcon and succeed", function () {
                var success = jasmine.createSpy(),
                    eventId = "self.profilebox.getItemIcon",
                    args,
                    options;
                ...
                index.self.profilebox.getItemIcon(success, null, args, null);

                expect(success).toHaveBeenCalled();
            });

            it("can call getItemIcon and fail", function () {
                var fail = jasmine.createSpy(),
                    eventId = "self.profilebox.getItemIcon",
                    args,
                    options;
                ...
                index.self.profilebox.getItemIcon(null, fail, args, null);
