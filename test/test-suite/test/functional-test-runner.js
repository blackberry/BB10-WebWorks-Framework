    ...
    it("runs the functional test app", function () {
        ...
        runs(function () {
            var testAppSrc = path.normalize(__dirname + "/../../test-app/"),
                testAppDst = path.normalize(input + "/wwTest/"),
                flag = false;
            ...
            utils.cp(path.join(testAppSrc, "automatic","SpecRunner.htm"), path.join(testAppDst, "index.html"));
            wrench.copyDirSyncRecursive(path.join(testAppSrc, "automatic", "spec"), path.join(testAppDst, "spec"));
            ...
            runs(function () {
                ...
                dt;
                runs(function () {
                    dt = new DeployTest(output + "/device/wwTest.bar");
