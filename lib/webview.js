...
webview =
    ...
    create: function (ready) {
        _webviewObj = window.qnx.webplatform.createWebView(function () {
            ...
            _webviewObj.setFileSystemSandbox = false;
    ...
    setContextMenuEnabled : function (enable) {
        if (enable) {
            _webviewObj.enableWebEventRedirect("ContextMenuRequestEvent", 3);
            _webviewObj.enableWebEventRedirect("ContextMenuCancelEvent", 3);
            _webviewObj.enableWebEventRedirect("PropertyCurrentContextEvent", 3);
        } else {
            _webviewObj.disableWebEventRedirect("ContextMenuRequestEvent", 3);
            _webviewObj.disableWebEventRedirect("ContextMenuCancelEvent", 3);
            _webviewObj.disableWebEventRedirect("PropertyCurrentContextEvent", 3);
        }
    }
};
