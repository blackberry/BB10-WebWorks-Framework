...
evt.on("NetworkResourceRequestedResponse", function (args) {
	console.log("NetworkResourceRequestedResponse");
	console.log(args);
...
*/
					qnx.callExtensionMethod("webview.notifyOpen", args.id, args.data.streamId, code, "OK");
					qnx.callExtensionMethod("webview.notifyHeaderReceived", args.id, args.data.streamId, "Access-Control-Allow-Origin", "*");
					qnx.callExtensionMethod("webview.notifyDataReceived", args.id, args.data.streamId, responseText, responseText.length);
					qnx.callExtensionMethod("webview.notifyDone", args.id, args.data.streamId);
                }
                else {
