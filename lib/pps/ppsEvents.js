            ...
            if (data) {
                ...
                if (eventObj) {
                    ...
                    if (fieldFound) {
                        ...
                        for (i = 0; !skipTrigger && i < eventDetailsArr.length; i++) {
                            ...
                            for (j = 0; j < eventDetailsArr[i].fieldNameArr.length; j++) {
                                ...
                                if (readObj[fieldNameObj.eventName]) {
                                    formattedValue = fieldNameObj.formatValue(readObj[fieldNameObj.eventName]);
                                    if (fieldNameObj.triggerCheck && fieldNameObj.triggerCheck(formattedValue)) {
                                        skipTrigger = true;
                                        break;
                                    }
                                    returnObj[fieldNameObj.paramName] = formattedValue;
                                }
                            }
                        }
