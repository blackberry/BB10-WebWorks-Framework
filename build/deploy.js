...
module.exports = function (barFile, deviceIp, password, bbDeploy) {
    bbDeploy = bbDeploy || conf.DEPLOY_COMMAND_DEFAULT_BB_DEPLOY;
    ...
    _exec(bbDeploy + " -installApp -launchApp " + "-package " +  barFile + " -device " + deviceIp + " -password " + password); 
};
